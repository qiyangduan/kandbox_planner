...
DATABASE_URI = os.environ['KPDJANGO_DATABASE_URL'] 
...
#For The_Company
KANDBOX_TEST_START_DAY = '20200422'  # s KANDBOX_JOB_MINIMUM_START_DAY # '20200402' 


KANDBOX_TEST_END_DAY  =  '20200501'
KANDBOX_TEST_OPTI1DAY_START_DAY  =  KANDBOX_JOB_MINIMUM_START_DAY # '20200503'
KANDBOX_TEST_OPTI1DAY_END_DAY  =  '20200427'

KANDBOX_OPTI1DAY_EXEC_SECONDS  =  5
KANDBOX_TEST_WORKING_DIR = '/tmp/The_Company/working_dir/working_20200414'
RL_MAX_EPOCHS = 5
RL_TRAINING_DAYS = 8
...
OSS_LOCAL_STORAGE_PATH = os.environ['KPLANNER'] 
